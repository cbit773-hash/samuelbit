# Bolt — Sistema de diseño InvestPRO

> **DEPRECADO** — Usar [INVESTPRO_DESIGN_SYSTEM.md](INVESTPRO_DESIGN_SYSTEM.md) y [public/design/DESIGN (3).md](../public/design/DESIGN%20(3).md).

> Fuente anterior: [public/DESIGN (2).md](../public/DESIGN%20(2).md)

## Checklist PR (obligatorio)

- [ ] Sin gradientes decorativos en fondos o títulos
- [ ] Sin `shadow-*` en cards (jerarquía por color de superficie)
- [ ] CTA principal: pill azul `#006cff`, texto blanco
- [ ] Inputs: fondo `#111426`, radius 5px, sin glass
- [ ] `primary` en Tailwind = skybound blue, no ámbar
- [ ] Buy/sell: verde/rojo solo en trading, no como CTA global
