...
3. **[Lógica de Negocio y Módulos Core](./docs/02_BUSINESS_LOGIC.md)**: Detalle del motor de trading, integración Web3 (Coinbase Wallet) y el módulo "Zaki Legal".
