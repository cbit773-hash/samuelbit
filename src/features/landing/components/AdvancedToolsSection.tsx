      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">Herramientas avanzadas para comerciantes modernos</h2>
            ...
            <Link to="/auth/login" className="inline-block bg-white/5 hover:bg-white/10 border border-white/10 text-white font-bold py-3 px-8 rounded-full transition-all">
            ...
            <div className="relative bg-[#0a0a0a] border border-white/10 rounded-2xl p-4 shadow-2xl">
              ...
              <div className="flex items-center justify-between border-b border-white/10 pb-4 mb-4">
                ...
                <div className="flex gap-2">
                  <span className="bg-white/5 px-3 py-1 rounded text-xs text-gray-400">1H</span>
                  <span className="bg-white/5 px-3 py-1 rounded text-xs text-gray-400">4H</span>
                  <span className="bg-primary/20 text-primary px-3 py-1 rounded text-xs font-bold">1D</span>
                </div>
              </div>
              
              <div className="h-64 w-full bg-[#111] rounded-lg border border-white/5 relative overflow-hidden flex items-center justify-center">
                {/* Abstract Chart Representation */}
                <LineChart size={120} className="text-white/5 absolute" />
