...
const TABS = [
  { id: 'overview', label: 'Overview', icon: Crown, color: 'text-brand' },
  { id: 'personnel', label: 'Personal', icon: Users, color: 'text-brand' },
  ...
  { id: 'settings', label: 'Config', icon: Settings, color: 'text-muted' },
] as const;
  ...
  return (
    <div className="flex flex-col gap-6 max-w-[1600px] mx-auto">
      <div className="border-b border-cyan-500/10 pb-4">
        ...
        <h1 className="text-3xl font-black text-foreground tracking-tight">Panel Head — <span className="text-cyan-400">Control Total</span></h1>
      </div>
