        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="prose prose-invert max-w-none space-y-8 text-gray-300 leading-relaxed text-[15px]">
            ...
            <section>
              ...
              <p>
                Esta política cumple con la <strong className="text-white">Ley 1581 de 2012</strong> (Ley de Protección de Datos Personales
                de Colombia), el <strong className="text-white">Decreto 1377 de 2013</strong>, y los lineamientos del
                <strong className="text-white"> Reglamento General de Protección de Datos (GDPR)</strong> de la Unión Europea,
            ...
            <section>
              ...
              <h3 className="text-lg font-semibold text-white mt-6 mb-3">2.1 Datos proporcionados por el usuario</h3>
              <ul className="list-disc pl-6 space-y-2">
                <li><strong className="text-white">Datos de registro:</strong> nombre completo, correo electrónico, número de teléfono, país de residencia.</li>
                <li><strong className="text-white">Datos de verificación (KYC):</strong> documento de identidad, comprobante de domicilio, selfie de verificación.</li>
                <li><strong className="text-white">Datos financieros:</strong> información de métodos de pago, historial de transacciones, direcciones de billeteras crypto.</li>
              </ul>

              <h3 className="text-lg font-semibold text-white mt-6 mb-3">2.2 Datos recopilados automáticamente</h3>
              <ul className="list-disc pl-6 space-y-2">
                <li><strong className="text-white">Datos de navegación:</strong> dirección IP, tipo de navegador, sistema operativo, páginas visitadas, duración de sesión.</li>
                <li><strong className="text-white">Cookies y tecnologías similares:</strong> utilizamos cookies esenciales, analíticas y de marketing (Google Analytics, Google Tag Manager, Hotjar).</li>
                <li><strong className="text-white">Datos de UTM:</strong> parámetros de campañas publicitarias para medir la efectividad de nuestro marketing.</li>
              </ul>
            </section>
            ...
            <section>
              <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
                <span className="w-8 h-8 rounded-lg bg-amber-500/10 flex items-center justify-center text-amber-500 text-sm font-black">4</span>
                Base Legal del Tratamiento
              </h2>
              <p>El tratamiento de sus datos se fundamenta en:</p>
              <ul className="list-disc pl-6 space-y-2">
                <li><strong className="text-white">Consentimiento:</strong> otorgado al registrarse en la plataforma y aceptar estos términos.</li>
                <li><strong className="text-white">Ejecución contractual:</strong> necesario para prestar los servicios contratados.</li>
                <li><strong className="text-white">Obligación legal:</strong> cumplimiento de normativas KYC/AML y fiscales.</li>
                <li><strong className="text-white">Interés legítimo:</strong> prevención de fraude y mejora del servicio.</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p>
                InvestPRO <strong className="text-white">no vende ni alquila</strong> sus datos personales a terceros. Podemos compartir
                información con:
              </p>
              <ul className="list-disc pl-6 space-y-2">
                <li><strong className="text-white">Proveedores de servicios:</strong> procesadores de pago (NOWPayments, Stripe), servicios de comunicación (Resend, Twilio), hosting (Supabase, Cloudflare).</li>
                <li><strong className="text-white">Autoridades legales:</strong> cuando sea requerido por ley o para proteger nuestros derechos.</li>
                <li><strong className="text-white">Socios de análisis:</strong> Google Analytics, Google Ads (datos anonimizados para optimización de campañas).</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li><strong className="text-white">Supresión:</strong> solicitar la eliminación de sus datos (sujeto a obligaciones legales de retención).</li>
                ...
                <li><strong className="text-white">Revocación del consentimiento:</strong> retirar su consentimiento en cualquier momento.</li>
              </ul>
              <p className="mt-4">
                Para ejercer estos derechos, envíe un correo a <strong className="text-amber-500">privacidad@investpro.com</strong> con
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li><strong className="text-white">Datos de cuenta:</strong> mientras la cuenta esté activa + 5 años después del cierre.</li>
                <li><strong className="text-white">Datos de transacciones:</strong> 10 años (obligación fiscal y AML).</li>
                <li><strong className="text-white">Datos de marketing:</strong> hasta la revocación del consentimiento.</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="list-none space-y-2 mt-3">
                <li className="flex items-center gap-2">📧 <strong className="text-white">Email:</strong> privacidad@investpro.com</li>
                <li className="flex items-center gap-2">📞 <strong className="text-white">Teléfono:</strong> +52 55 1837 0627</li>
                <li className="flex items-center gap-2">🏢 <strong className="text-white">Oficial de Protección de Datos:</strong> dpo@investpro.com</li>
              </ul>
            </section>
      ...
      <footer className="border-t border-white/5 py-8">
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-gray-500">
          <div className="flex items-center gap-4">
            ...
            <Link to="/legal/privacidad" className="text-amber-500 font-bold">Política de Privacidad</Link>
          </div>
